...
import com.zhuchao.android.ktv.widgets.ImgConstraintLayout;
import com.zhuchao.android.ktv.widgets.focus.MyFocusHighlightHelper;
 ...
 * Description  :
 */
public class Type7ContentPresenter extends Presenter {
    ...
    public Presenter.ViewHolder onCreateViewHolder(ViewGroup parent) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_type_7_layout, parent, false);
