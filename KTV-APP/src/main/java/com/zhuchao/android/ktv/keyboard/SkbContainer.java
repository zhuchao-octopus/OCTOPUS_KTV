...
public class SkbContainer extends RelativeLayout implements SoftKeyBoardable {
    ...
    private boolean setKeyCodeEnter(SoftKey softKey) {
        if (softKey == null) {
            MMLog.log(TAG, "setKeyCodeEnter softKey is null");
            return false;
        }
    ...
    public boolean onSoftKeyDown(int keyCode, KeyEvent event) {
        ...
        MMLog.log(TAG, "onSoftKeyDown keyCode:" + keyCode);
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_DPAD_CENTER:
                ...
                MMLog.log(TAG, "onSoftKeyDown softKey:" + softKey);
            ...
            default:
                MMLog.log(TAG, "onSoftKeyDown false keyCode:" + keyCode);
                return false;
        }
        MMLog.log(TAG, "onSoftKeyDown true keyCode:" + keyCode);
        return true;
    }
    ...
    public boolean onSoftKeyUp(int keyCode, KeyEvent event) {
        ...
        MMLog.log(TAG, "onSoftKeyUp keyCode:" + keyCode);
        if (mSoftKeyboardView != null)
            mSoftKeyboardView.setSoftKeyPress(false);
        switch (keyCode) {
            case KeyEvent.KEYCODE_ENTER:
            ...
            case KeyEvent.KEYCODE_DPAD_DOWN: // 下
            case KeyEvent.KEYCODE_BACK:
                MMLog.log(TAG, "onSoftKeyUp true keyCode:" + keyCode);
                return true;
        }
        MMLog.log(TAG, "onSoftKeyUp false keyCode:" + keyCode);
        return false;
    }
