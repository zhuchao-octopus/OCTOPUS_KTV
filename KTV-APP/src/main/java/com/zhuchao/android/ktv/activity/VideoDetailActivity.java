...
import com.zhuchao.android.cabinet.OVideoPlayer;
import com.zhuchao.android.ktv.R;
import com.zhuchao.android.ktv.base.BaseActivity;
import com.zhuchao.android.ktv.bean.Video;
import com.zhuchao.android.ktv.presenter.EpisodeContentPresenter;
import com.zhuchao.android.ktv.presenter.EpisodeGroupPresenter;
...
public class VideoDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    private OVideoPlayer videoPlayer;
...
//        mHgEpisodeGroup.setFocusScrollStrategy(HorizontalGridView.FOCUS_SCROLL_ITEM);
    ...
    private final Thread thread = new Thread(new Runnable() {
        @Override
        public void run() {
            String json = LocalJsonResolutionUtil.getJson(VideoDetailActivity.this, "Video.json");
