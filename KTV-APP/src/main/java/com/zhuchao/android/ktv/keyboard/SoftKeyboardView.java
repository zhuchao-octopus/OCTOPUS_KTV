...
public class SoftKeyboardView extends View {
    ...
    protected void onDraw(Canvas rootCanvas) {
        ...
        if (mCacheBitmap == null) {
            MMLog.log(TAG, "onDraw mCacheBitmap:" + mCacheBitmap);
    ...
    public void setSoftKeyPress(boolean isPress) {
        if (mSoftKeyboard == null) {
            MMLog.log(TAG, "setSoftKeyPress isPress:" + isPress);
            return;
        }
    ...
    public boolean moveToNextKey(int direction) {
        if (mSoftKeyboard == null) {
            MMLog.log(TAG, "moveToNextKey mSoftKeyboard is null");
            return false;
        }
        ...
        if (keyRow == null) {
            MMLog.log(TAG, "moveToNextKey keyRow is null");
            return false;
        }

        List<SoftKey> softKeys = keyRow.getSoftKeys();
        if (softKeys == null) {
            MMLog.log(TAG, "moveToNextKey keyRow -> softKeys is null");
            return false;
        }
